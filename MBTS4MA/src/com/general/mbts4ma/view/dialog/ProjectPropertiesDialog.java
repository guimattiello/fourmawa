	...
	public ProjectPropertiesDialog(GraphProjectVO graphProject) {
			...
			addGroup(gl_contentPanel.createSequentialGroup().addContainerGap().
				addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).
					addGroup(Alignment.TRAILING, gl_contentPanel.createSequentialGroup().
						addComponent(this.txtAndroidProjectPath, GroupLayout.DEFAULT_SIZE, 366, Short.MAX_VALUE).
						addPreferredGap(ComponentPlacement.UNRELATED).
						addComponent(this.btnSelectAndroidProject, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE).
						addPreferredGap(ComponentPlacement.RELATED).
						addComponent(btnVerifyAndroidProject, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
					).
					...
					addComponent(lblAndroidProjectPath, GroupLayout.PREFERRED_SIZE, 165, GroupLayout.PREFERRED_SIZE).
					addComponent(lblApplicationPackage, GroupLayout.PREFERRED_SIZE, 165, GroupLayout.PREFERRED_SIZE).
					addComponent(lblMainTestingActivity, GroupLayout.PREFERRED_SIZE, 165, GroupLayout.PREFERRED_SIZE).
					addComponent(this.txtApplicationPackage, GroupLayout.PREFERRED_SIZE, 320, GroupLayout.PREFERRED_SIZE).
					addComponent(this.cmbMainTestingActivity, GroupLayout.PREFERRED_SIZE, 250, GroupLayout.PREFERRED_SIZE)
				).
				addContainerGap()
			)
		);
		...
		gl_contentPanel.setVerticalGroup(
			...
			addGroup(gl_contentPanel.createSequentialGroup().
				...
				addPreferredGap(ComponentPlacement.RELATED).
				addComponent(lblAndroidProjectPath, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).
				addPreferredGap(ComponentPlacement.RELATED).
				addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).
					addGroup(gl_contentPanel.createSequentialGroup().
						addComponent(this.txtAndroidProjectPath, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE).
						addGap(12).
						addComponent(lblApplicationPackage, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).
						addPreferredGap(ComponentPlacement.RELATED).
						addComponent(this.txtApplicationPackage, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE).
						addPreferredGap(ComponentPlacement.RELATED).
						addComponent(lblMainTestingActivity, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).
						addPreferredGap(ComponentPlacement.RELATED).
						addComponent(this.cmbMainTestingActivity, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
					).
					addComponent(btnVerifyAndroidProject, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE).
					addComponent(this.btnSelectAndroidProject, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
				).
		...
		this.contentPanel.setLayout(gl_contentPanel);
		{
			...
			gl_buttonPane.setHorizontalGroup(
				...
				addGroup(
					...
					addComponent(btnConfirm, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).
					addComponent(btnCancel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE).addContainerGap(288, Short.MAX_VALUE)
				)
			);
			...
			gl_buttonPane.setVerticalGroup(
				gl_buttonPane.createParallelGroup(Alignment.LEADING).
				addGroup(
					gl_buttonPane.createSequentialGroup().addContainerGap().addGroup(gl_buttonPane.createParallelGroup(Alignment.TRAILING).
						addComponent(btnConfirm, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE).
						addComponent(btnCancel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					)
			);
