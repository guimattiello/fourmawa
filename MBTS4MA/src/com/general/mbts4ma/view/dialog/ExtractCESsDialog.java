...
public class ExtractCESsDialog extends JDialog {
		...
		if (this.graphProject.getIsWebProject()){
			this.btnGenerateTestingCodeSnippets.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
						ExtractCESsDialog.this.generateTestingCodeSnippetsForWeb();												
					} catch (Exception e2) {
						e2.printStackTrace();
					}
				}
	...
	public void generateTestingCodeSnippetsForWeb() throws Exception {
		...
		//File testingWebCodeSnippetsDirectory = new File(this.graphProject.getFileSavingDirectory() + File.separator + "testing-web-code-snippets");
